          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="bg-white shadow-sm rounded-lg border overflow-hidden">
              <div className="grid grid-cols-1 lg:grid-cols-5">
                ...
                <div className="lg:col-span-2 bg-terracotta/10 p-8">
                  <h2 className="text-xl font-semibold mb-6">Nos coordonnées</h2>
                  
                  <div className="space-y-6">
                    <div className="flex items-start space-x-3">
                      <div className="bg-terracotta/20 p-2 rounded-full">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">123 Rue Principale, Cotonou, Bénin</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">contact@3w-loc.com</p>
                      </div>
                    </div>
                  ...
                  <div className="mt-8">
                    ...
                    <div className="flex space-x-3">
                      <a href="#" className="bg-terracotta/20 p-2 rounded-full hover:bg-terracotta/30 transition-colors">
                        <svg className="w-5 h-5 text-terracotta" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            {/* Carte (simulation) */}
            <div className="mt-12 bg-gray-200 rounded-lg overflow-hidden h-64 flex items-center justify-center text-center">
              <div>
                <p className="text-gray-600">Carte de localisation</p>
                <p className="text-gray-500 text-sm">Simulation de carte Google Maps</p>
              </div>
            </div>
          </div>
        </div>
